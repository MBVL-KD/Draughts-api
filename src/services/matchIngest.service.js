...
const completedMatchPayloadSchema = z.object({
  matchId: z.string(),
...
const finalizedMatchSchema = z.union([
  completedMatchPayloadSchema,
  z.object({
    dedupeKey: z.string().optional(),
    type: z.literal("completed_match").optional(),
    payload: completedMatchPayloadSchema,
  }),
]);
